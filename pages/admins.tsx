...
import { AdminType, AdminsPageProps } from '../types';

// Admins Page
// Allows user to add and delete admins
const AdminsPage: React.FC<AdminsPageProps> = ({ swal }) => {
  const [email, setEmail] = useState<string>('');
  const [adminEmails, setAdminEmails] = useState<AdminType[]>([]);
  ...
  function deleteAdmin(admin: AdminType) {
    swal
      .fire({
        title: 'Are you sure?',
